...
const targetStr = `
    const getSignatureHtml = () => \`
        <div class="signature-area">
           <div class="signature-left"><strong>Müdür Yardımcısı</strong><br/><br/><br/>\${schoolInfo.vicePrincipal || '...........................'}</div>
           <div class="signature-right"><strong>Okul Müdürü</strong><br/><br/><br/>\${schoolInfo.principal || '...........................'}</div>
        </div>
    \`;
`;
...
code = code.replace("htmlContent += getSignatureHtml();", "htmlContent += getSignatureHtml(key);"); // For individual tables
code = code.replace("htmlContent += getSignatureHtml();", "htmlContent += getSignatureHtml();"); // Replace the first one (for Genel)
